...
const Description = () => {
  return (
    <>
      <div className="">
        <div className="mx-auto container pt-28 lg:pt-36 flex lg:flex-row justify-center lg:items-center lg:justify-between text-center flex-col">
          <div className="flex flex-col lg:w-4/12">
            ...
            {/* <div className=" lg:flex flex justify-around  lg:flex-row lg:gap-6">
          ...
          <div className="flex lg:flex-row flex-col gap-10 lg:gap-0  lg:w-7/12 justify-between pt-14">
            {/* <div className="lg:font-normal lg:w-6/12 leading-10 lg:text-base lg:text-white lg:text-left ">
            ...
            <div className="lg:font-normal lg:w-6/12 lg:text-base leading-10 lg:text-white lg:text-left ">
