...
const PopUp = ({ modal, handleModal, data, name }) => {
  return (
    <Modal open={modal} onClose={handleModal} className="bg-btnHoverBlack ">
      <ModalContent className="bg-btnHoverBlack text-white md:w-[600px] w-[360px] overflow-y-scroll px-5 rounded-2xl h-[80vh] text-[10px] md:text-sm flex flex-col justify-between text-center">
        <section>
