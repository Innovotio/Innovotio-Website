...
const AboutHeader = () => {
  return (
    <section className="lg:pt-44 pt-20 px-5 container mx-auto">
      <div className="text-white w-12/12 flex lg:flex-row flex-col lg:items-center lg:space-x-4 justify-between">
        <div className="lg:w-5/12 w-full">
          <h2 className="lg:text-4xl leading-7  md:max-w-md max-w-lg md:text-2xl text-xl font-medium">
            Our mission is to connect competent tech talents to hiring
            organizations.
          </h2>
        </div>
        <div className="font-light lg:w-5/12 w-full leading-8 lg:pt-0 pt-4 lg:text-lg max-w-lg md:text-base text-base text-headerGrey">
          <p>
