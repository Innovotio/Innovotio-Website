      ...
      <div data-aos="fade-right">
        ...
        <div className="grid lg:grid-cols-4 grid-cols-2 gap-4 max-w-sm md:max-w-full lg:max-w-4xl pt-6">
          <button
            ...
            className={
              options.month === 1
                ? "bg-primaryYellow lg:w-[189px] w-[118px] h-[44px] text-lg lg:text-2xl text-black font-medium lg:h-[76px] rounded-full text"
                : "lg:w-[189px] w-[118px] h-[44px] text-lg lg:text-2xl text-white font-medium lg:h-[76px] rounded-full bg-btnHoverBlack text"
            }
          >
            1 month
          </button>
