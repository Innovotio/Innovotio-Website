...
function Operations() {
  return (
    <section className="flex-col lg:flex-row lg:items-center lg:justify-evenly border-t border-b mx-auto container text-white lg:mt-32 md:mt-24 mt-14 py-12 border-btnDefaultBlack leading-tight md:mx-8 px-5 flex ">
