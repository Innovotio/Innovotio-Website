...
const Tal = () => {
  return (
    <nav className="w-5/6 2xl:mx-auto 2xl:left-28 2xl:container 2xl:w-full right-28 z-50 cursor-pointer h-52 bg-black items-center rounded-xl border-headerGrey absolute top-20 justify-between flex border border-opacity-30">
